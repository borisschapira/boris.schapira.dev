...
Et si la curiosité vous anime toujours, vous pouvez aller jusqu'à  lire quelques articles d'Economie (par exemple la définition de l'inflation - [//fr.wikipedia.org/wiki/Inflation](//fr.wikipedia.org/wiki/Inflation) -, ça ne fait pas de mal) voire même acheter un ou deux livres (soyons fous).