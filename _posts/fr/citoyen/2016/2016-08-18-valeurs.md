...
sentiments contraires sur lesquels je mets du temps à mettre des mots, pas
vous ?). Merci donc de lire l'ensemble avant de me traiter de tous les noms,
j'ai déjà eu ma dose ces derniers jours.
...
> Après le "burkini" quel autre attribut vestimentaire, quelle attitude, seront
...
En creusant un peu plus loin mes propres sentiments et en discutant avec des
...
est profondément inhumaine. Certain·es salarié·es ne correspondant pas à cet
idéal son mis à l'écart, cachés, sans jamais être licencié·es pour autant.
