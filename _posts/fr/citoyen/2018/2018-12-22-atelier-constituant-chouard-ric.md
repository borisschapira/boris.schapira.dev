...
{% capture img_alt %}Un carnet de notes griffonées{% endcapture %} {% capture img_caption %}Les notes qui m'ont permis d'écrire cet article{% endcapture %} {% include rwd-image.html.liquid
