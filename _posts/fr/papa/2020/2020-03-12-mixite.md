...
{% capture alt_text%}Dessin de trois femme prenant la pause comme pour montrer leur muscle. Derrière elles, des fusées décollent.{% endcapture %}{% capture caption_text%}Les femmes n'ont pas à rester les Figures de l'Ombre.{% endcapture %}{% include video_as_a_gif.html.liquid
