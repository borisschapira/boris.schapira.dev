...
<figure>
  <img src="{{ page.url }}waiting.gif" alt="Lenny, des Simpsons, est concentré."/>
...
<figure>
  <img src="{{ page.url }}dafuq.gif" alt="Ron Winsley se demande se qui se passe."/>
...
<figure>
  <img src="{{ page.url }}excited.gif" alt="Un jeune garçon, visiblement content d'être filmé par la caméra du stade où il se trouve pour assister à un match, entâme une danse très… particulière."/>
...
<figure>
  <img src="{{ page.url }}blow.gif" alt="Des visages de jeunes femmes capturés en slow motion, tandis qu'un souffle très fort est envoyé de face"/>
...
<figure>
  <img src="{{ page.url }}waterfall.gif" alt="Une cascade"/>
...
<figure>
  <img src="{{ page.url }}surprised.gif" alt="Lindsay Lohann est surprise."/>
...
<figure>
  <img src="{{ page.url }}panic.gif" alt="Sheldon, de The Big Bang Theory, panique et souffle dans un sac en papier"/>
...
<figure>
  <img src="{{ page.url }}getout.gif" alt="Cary Grant demander à ce qu'on sorte"/>
...
<figure>
  <img src="{{ page.url }}business.gif" alt="Big Ang ne rigole pas avec le taf"/>
...
<figure>
  <img src="{{ page.url }}facepalm.gif" alt="Stehen Colbert a besoin de 4 mains pour se lamenter"/>
