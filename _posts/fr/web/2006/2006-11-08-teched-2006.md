...
- Glass dans les applications .Net ("For the last 20 years, it was just Windows.
  Now it have Glass")
...
- Les fonctions avancées de la bibliothèque de redémarrage (après une mise à
  jour ou un crash)
- La création de gadgets pour la sidebar (moins intéressant à mon sens mais qui
  pourrait, à terme, remplacer la Taskbar) en HTML, XML et JScript.
