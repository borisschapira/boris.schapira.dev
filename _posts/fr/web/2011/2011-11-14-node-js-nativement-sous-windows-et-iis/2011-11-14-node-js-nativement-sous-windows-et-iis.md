...
{:.canonical}
**Note&nbsp;:** l'article ci-dessous a été publié sur [Clever Age](http://www.clever-age.com/fr/) dans [Node.js, nativement sous Windows et IIS](http://blog.clever-age.com/fr/2011/11/14/node-js-nativement-sous-windows-et-iis/).
