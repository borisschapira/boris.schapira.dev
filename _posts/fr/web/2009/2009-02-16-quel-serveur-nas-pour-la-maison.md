...
**Et vous, quelle solution utilisez-vous pour stocker vos données ? Un gros disque, un serveur ? Avez-vous un serveur NAS ? Si oui, lequel et pourquoi ? Quels en sont selon vous les avantages (extensibilité, multimédia…) et les inconvénients (bruit, espace….) ? **
