...
Ce site est généré via [Jekyll](https://jekyllrb.com/), un générateur de sites statiques en Ruby, dont les dépendances sont gérées par [Bundler](http://bundler.io/) :
...
* la génération du fichier `sitemap.xml` est à la charge `jekyll-sitemap` ;
